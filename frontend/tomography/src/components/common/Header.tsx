    ...
    >
      ...
      >
        <Button
          ...
          sx={{
            backgroundColor: isActive("/tomography")
              ? "primary.main"
              : "transparent",
            color: isActive("/tomography") ? "white" : "primary.main",
            "&:hover": {
              backgroundColor: isActive("/tomography")
                ? "primary.dark"
        ...
        <Button
          ...
          sx={{
            backgroundColor: isActive("/tomography/methods")
              ? "primary.main"
              : "transparent",
            color: isActive("/tomography/methods") ? "white" : "primary.main",
            "&:hover": {
              backgroundColor: isActive("/tomography/methods")
                ? "primary.dark"
                : "rgba(25, 118, 210, 0.04)",
