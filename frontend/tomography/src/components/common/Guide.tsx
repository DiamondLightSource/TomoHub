    ...
    <>
      ...
      >
        ...
        <Typography variant="body1" gutterBottom>
          ...
          <br />
          Tomohub provides all avalialbe methdods in HTTOMO (Httomolib,
          Httomolibgpu) and allows users to setup their pipeline for
          reconstruction, create/modify YAML config files and run the pipeline
          with HTTOMO as well (powered by workflows)
        </Typography>
