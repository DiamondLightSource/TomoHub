...
import { Select, MenuItem, FormControl, InputLabel, SelectChangeEvent,Card,Typography,Tooltip } from "@mui/material";
...
const PipelineSelector: React.FC = () => {
  const [pipelines, setPipelines] = useState<ApiFullPipelineSchema | null>(null);
  ...
  return (
    ...
    <FormControl fullWidth>
      <InputLabel size="small" id="pipeline-select-label">Select Pipeline</InputLabel>
      <Select
