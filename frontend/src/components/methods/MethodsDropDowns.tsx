...
import * as MethodComponents from '.';
...
const methodComponents = {
  'Image Saving': MethodComponents.ImageSaving,Segmentation: MethodComponents.Segmentation,
  'Morphological Operations': MethodComponents.Morphological,Normalisation: MethodComponents.Normalisation,
  ...
  'Rotation Center Finding': MethodComponents.RotationCenterFinding,Algorithms: MethodComponents.Reconstruction,
};
